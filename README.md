...
Nsanku is an initiative that evaluates how well various open-source language models perform when working with Ghanaian languages. **We have evaluated the performance of over 14 open-source and closed models across 43 languages, using at least 300 sentences (sourced from religious text) per language.** Paper publication coming soon.
